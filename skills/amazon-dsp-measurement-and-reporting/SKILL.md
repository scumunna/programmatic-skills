...
- **View-through requires a viewable impression.** A view-through conversion is credited only if the impression met the Media Rating Council standard for a viewable impression (broadly, at least 50 percent of the ad's pixels in view for at least one second). A served-but-not-viewed impression does not earn view-through credit.
